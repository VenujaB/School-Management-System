...
<br>
            <div class="row">
                <div class="col-12">
                   <h1 class="text-center">Search Booking</h1>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-12">
                    <div class="border ml-3 mr-3 bg-light shadow">
                        <form class="mt-3 ml-3 mr-3 mb-3" action = "StudentBookViewServlet" method = "post">
                            <br>
                            ...
                            <br>
                            <div class="form-group">
                                <button type="submit" class="btn btn-success btn-lg btn-block text-center">Search</button> 
                            </div>
                        </form>    
                    </div>        
                </div>
...
<br>
            <div class="row">
                ...
                <img src="images/Search.png " height="600px" width="100%" class="text-center">
                </div>
            </div>
