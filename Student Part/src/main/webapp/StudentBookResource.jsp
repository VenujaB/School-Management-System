...
<head>
    ...
    <title>Booking Resource Page</title>
...
<div class="col-lg-0 col-0">
    ...
    <div class="col-lg-4 col-12">
        <div class="border  ml-3 bg-light shadow" >
            <form class="mt-3 ml-3 mr-3 mb-3" action = "StudentBookResourceInsertServlet" method = "post">
                <div class="form-group">
                    <label>Resource ID</label>
                    <input type="text" class="form-control" name= "bookid" placeholder = "Resource ID">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder = "Resource Type" name ="rtype" >
                </div>
                <div class="form-group">
                ...
                <div class="text-center form-group">
                    <button type="submit" class="btn btn-success text-center">Booking Now</button> 
                </div>

            </form>
            
            
           <form class="text-center form-group" action = "StudentBookingSearch.jsp">
           <button type="submit" class="btn btn-primary text-center">View Booking</button>
            </form>
             <br>
