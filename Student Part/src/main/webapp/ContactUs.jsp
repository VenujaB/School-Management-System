    ...
    <div class="col-lg-0 col-0 ml-5">
        ...
        <div class="col-lg-4 col-12">
            <div class="border ml-3 mr-3 bg-light shadow">
                <form class="mt-3 ml-3 mr-3 mb-3" action = "ContactUsServlet" method = "post">
                    ...
                    <div class="form-group">
                        <label >Message</label>
                        <textarea class="form-control" rows="3" name = "msg" placeholder = "Type Here Your Message"></textarea>
                        <br>
                    </div>
                    <div class="text-center">
                        <button type="submit" class="btn btn-success btn-lg btn-block text-center mb-5">Send Message</button> 
                    </div>  
                    </form>                                    
            </div>
        </div>
        <div class="col-lg-7 col-12">
            <img src='images/contct.jpg' height="440px" width="100%" class="ml-4">
        </div>
