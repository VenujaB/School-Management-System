...
<head>
    ...
    <title>Time Table Display Page</title>
...
<tr>
 ...
 <c:forEach var ="tb" items ="${TimeTableDetails}">
	
	<c:set var = "id" value = "${tb.getId() }"/>
	<c:set var = "ModuleID" value = "${tb.getModuleID()}"/>
	<c:set var = "Grade" value = "${tb.getGrade()}"/>
	<c:set var = "Time" value = "${tb.getTime()}"/>
	<c:set var = "Date" value = "${tb.getDate()}"/>
