        ...
        <div class="collapse navbar-collapse " id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item h6 ml-4">
              <a class="nav-link active" href="StudentModule.jsp">Module</a>
            </li>
...
<div class="container">
    <diV class="card-deck">
        <div class="card shadow"><img src="images/mths.jpg" class="card-img-top" width="300px" height="300px">
            <div class="card-body">
                <h4 class="card-title text-center">Mathematics</h4>
                <br>
                    <a href="#" class="btn btn-primary btn-lg btn-block text-center">Enroll</a>
            </div>
        </div>  

              <div class="card shadow">
                <img src="images/since.jpg" class="card-img-top" width="300px" height="300px">
                <div class="card-body">
                    <h4 class="card-title text-center">Science</h4>
                    <br>
                    <a href="#" class="btn btn-primary btn-lg btn-block text-center">Enroll</a>
                  </div>
                </div>    
                  ...
                  <div class="card shadow">
                    <img src="images/history.jpg" class="card-img-top" width="300px" height="300px">
                    <div class="card-body">
                    ...
                    <div class="card shadow">
                        <img src="images/english.jpg" class="card-img-top" width="300px" height="300px">
                        <div class="card-body">
