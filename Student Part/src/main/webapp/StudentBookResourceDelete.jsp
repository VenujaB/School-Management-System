...
<head>
    ...
    <title>Booking Resource Delete Page</title>
...
%>
    ...
    <div class="col-lg-4 col-12">
        <div class="border  ml-3 bg-light shadow" >
            <form class="mt-3 ml-3 mr-3 mb-3" action = "StudentBookResourceDeleteServlet" method = "post">
                <div class="form-group">
                    <label>Resource ID</label>
                    <input type="text" class="form-control" name= "bookid" placeholder = "Resource ID"  value = "<%=ResourceID%>" readonly>
                </div>
                <div class="form-group">
                    <label>Student Name</label>
                    <input type="text" class="form-control"  placeholder = "Student Name" name ="sname" value = "<%=StuName%>" readonly>
                </div>
                <div class="form-group">
                    <label >Email Address</label>
                    <input type="email" class="form-control" placeholder = "Email Address" name= "email" value = "<%=StuEmail%>" readonly>
                </div>
                <div class="form-group">
                    <label>Mobile Number</label>
                    <input type="number" class="form-control" placeholder = "Mobile Number" name ="mobile"  value = "<%=StuMobile%>" readonly>
                </div>
                <div class="form-group">
                    <label>Resource Type</label>
                    <input type="text" class="form-control" placeholder = "Resource Type" name ="rtype" value = "<%=ResourceType%>"  readonly>
                </div>
                <div class="form-group">
                    <label>Booking Date</label>
                    <input type="date" class="form-control" name = "date" value ="<%=BookDate%>"  readonly>
                </div>
                <div class="form-group">
                    <label>Booking Time</label>
                    <input type="time" class="form-control" name = "time" value ="<%=BookTime%>"  readonly>
                </div>
                <br>
