...
<div class="col-lg-4 col-0">
        ...
        <div class="col-lg-4 col-12">
            <div class="border ml-3 mr-3 bg-light shadow">
                <form class="mt-3 ml-3 mr-3 mb-3" action = "StudentUpdateServlet" method = "post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value = "<%=student.getSName()%>" name = "sname">
                    </div> 
                    <div class="form-group">
                        <label >Student Name</label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" value = "<%=student.getSContact()%>" name = "scontact">
                    </div>
                    <div class="form-group">
                        <label >Student Permanent Address</label>
                        <input type="text" class="form-control" value = "<%=student.getSLocation()%>" name = "slocation">
                        
                    </div>
                     <div class="form-group">
                        <label >Student Date Of Birth</label>
                        <input type="date" class="form-control" value = "<%=student.getSdob()%>" name = "sdob">
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control" value = "<%=student.getSPassword()%>" name = "spass">
