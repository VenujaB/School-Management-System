...
<head>
    ...
    <title>Admin Update Teacher Details</title>
    ...
    <div class="col-lg-0 col-0 ml-5">
        ...
        <div class="col-lg-4 col-12">
            <div class="border ml-3 mr-3 bg-light shadow">
                <form class="mt-3 ml-3 mr-3 mb-3" action="Admin_Update_Teacher_Servelet" method="post">
        ...
        <div class="col-lg-7 col-12">
            <img src="pic/EU01.jpg " height="700px" width="110%" class="ml-2">
        </div>
