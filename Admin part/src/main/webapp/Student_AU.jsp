...
<head>
    ...
    <title>Student Add & Update </title>
        ...
        <div class="container">
            <diV class="card-deck">
                ...
                <div class="card text-dark bg-white mb-3 shadow">
                  <img src="pic/152.jpg" class="card-img-top" width="400px" height="400px">
                    <div class="card-body">
                        <h5 class="card-title text-center">Add new Student</h5>
						 
    <center><a href="AdminInsert.jsp" class="btn btn-primary">Click Here</a></center>
                        
                    </div>
                </div>  
    
                      <div class="card text-dark bg-white mb-3 shadow">
                         <img src="pic/153.jpg" class="card-img-top" width="400px" height="400px">
                           <div class="card-body">
                             <h5 class="card-title text-center">Update Student</h5>
                             <center><a href="adminSearch.jsp" class="btn btn-primary">Click Here</a></center>
                           </div>
                        </div>    
