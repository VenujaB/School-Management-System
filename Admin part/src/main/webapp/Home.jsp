            ...
            <div class="carousel slide carousel-fade " data-ride="carousel" id="exampleController">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active" data-interval="2000">
                        <img src="pic/1.jpg" class="d-bolck w-100" >     
                    </div>
                    <div class="carousel-item" data-interval="2000">
                        <img src="pic/2.jpg" class="d-bolck w-100" >
                    </div>
                    <div class="carousel-item" data-interval="2000" >
                        <img src="pic/3.jpg" class="d-bolck w-100" >
                    </div>
                    <div class="carousel-item" data-interval="2000" >
                        <img src="pic/4.jpg" class="d-bolck w-100">
                    </div>
                    <div class="carousel-item" data-interval="2000" >
                        <img src="pic/5.jpg" class="d-bolck w-100">
                    </div>
                    <div class="carousel-item" data-interval="2000" >
                        <img src="pic/6.jpg" class="d-bolck w-100">
                    </div>
                    <div class="carousel-item" data-interval="2000" >
                        <img src="pic/7.jpg" class="d-bolck w-100">
                    </div>
                </div>
        ...
        <div class="container">
            <diV class="card-deck">
                ...
                <div class="card text-white bg-success">
                  <img src="pic/lab.jpg" class="card-img-top" width="250px" height="250px">
                    <div class="card-body">
                      ...
                      <div class="card text-white bg-danger">
                         <img src="pic/rugby.jpg" class="card-img-top" width="250px" height="250px">
                           <div class="card-body">
                        ...
                        <div class="card text-white bg-warning">
                            <img src="pic/cricket.jpg" class="card-img-top" width="250px" height="250px">
                            <div class="card-body">
                        ...
                        <div class="card text-white bg-info">
                            <img src="pic/swmming.jpg" class="card-img-top" width="250px" height="250px">
                              <div class="card-body">
