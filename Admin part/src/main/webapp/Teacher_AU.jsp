...
<head>
    ...
    <title>Teacher Add & Update </title>
        ...
        <div class="container">
            <diV class="card-deck">
                ...
                <div class="card text-dark bg-white mb-3 shadow">
                  <img src="pic/te001.jpg" class="card-img-top" width="400px" height="400px">
                    <div class="card-body">
                        <h5 class="card-title text-center">Add new Teacher</h5>
						 
    <center><a href="AdminInsertTeacher.jsp" class="btn btn-primary">Click Here</a></center>
                        
                    </div>
                </div>  
    
                      <div class="card text-dark bg-white mb-3 shadow">
                         <img src="pic/stuU.jpg" class="card-img-top" width="400px" height="400px">
                           <div class="card-body">
                             <h5 class="card-title text-center">Update Teacher</h5>
                             <center><a href="adminSearchTeacher.jsp" class="btn btn-primary">Click Here</a></center>
                           </div>
                        </div>    
