...
<div class="container">
    <diV class="card-deck">
       ...
       <div class="card shadow">
                    <img src="pic/adminln2.jpg" class="card-img-top" width="300px" height="300px">
                    <div class="card-body">
                        <h4 class="card-title text-center">Admin</h4>
                        <p class="card-text text-center">Login as a Admin</p>
                        <a href="Admin login.jsp" class="btn btn-primary btn-lg btn-block text-center">Login</a>
                      </div>
                    </div>  
    
    
        <div class="card shadow"><img src="pic/student.png" class="card-img-top" width="300px" height="300px">
            <div class="card-body">
              ...
              <div class="card shadow">
                <img src="pic/teacher.png" class="card-img-top" width="300px" height="300px">
                <div class="card-body">
                    <h4 class="card-title text-center">Teacher</h4>
                    <p class="card-text text-center">Login as a Teacher</p>
                    <a href="LoginTeacher.jsp" class="btn btn-primary btn-lg btn-block text-center">Login</a>
                  </div>
                </div>    

                  <div class="card shadow">
                    <img src="pic/hr manager.png" class="card-img-top" width="300px" height="300px">
                    <div class="card-body">
