...
<br>
       ...
       <form class="mt-3 ml-3 mr-3 mb-3" action = "AdminDisplayServelet" method = "post">
           
       <%
       
       	Admin admin = (Admin)request.getAttribute("adminDetails");
       
       %>
       
       <div class="form-group">
             <label>Admin ID</label>
              <input type="text" class="form-control" value ="<%=admin.getId()%>" name = "Aid" readonly>
            </div>
            
			<div class="form-group">
                <label >Admin Name</label>
                <input type="text" class="form-control" value = "<%=admin.getName()%>" name = "Aname" readonly>
            </div>
            
              <div class="form-group">
                        <label >Admin Email</label>
                        <input type="text" class="form-control" value = "<%=admin.getEmail()%>" name = "email" readonly>
                    </div>
                    
                      <div class="form-group">
                        <label >Admin Contact Number</label>
                        <input type="text" class="form-control" value = "<%=admin.getPhone()%>" name = "phone" readonly>
                      
                    </div>
                   
                     <div class="form-group">
                        <label >Admin Username</label>
                        <input type="text" class="form-control" value = "<%=admin.getUserName()%>" name = "Uname" readonly>
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control" value = "<%=admin.getPassword()%>" name = "pass" readonly>
                     </div>  
       ...
       <br>
       	<div class="text-center">
                     <a href="Admin dashbord.jsp">   <button type="submit" class="btn btn-success text-center shadow ml-2">Back to Admin Main</button> </a>
                    </div>  
                    <br>
      </div>
