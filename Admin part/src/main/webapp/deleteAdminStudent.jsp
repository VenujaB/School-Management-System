    ...
    <div class="col-lg-0 col-0 ml-5">
        ...
        <div class="col-lg-4 col-12">
            <div class="border ml-3 mr-3 bg-light shadow">
                <form class="mt-3 ml-3 mr-3 mb-3" action="Admin_Delete_Student_Servelet" method="post">
                 ...
                 <div class="form-group">
	               ...
	               <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control"name="dob" value="<%=birth%>"readonly>
                    </div>
                    ...
                    <div class="text-center">
                        <input type="submit" name="delete" value="Delete Account"class="btn btn-success btn-lg btn-block text-center mb-5">
        ...
        <div class="col-lg-7 col-12">
            <img src="pic/delete.jpg " height="600px" width="110%" class="ml-2">
        </div>
...
<!--  
<form action="Admin_Delete_Student_Servelet" method="post">
