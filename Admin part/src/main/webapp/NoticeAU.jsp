        ...
        <div class="container">
            <diV class="card-deck">
                ...
                <div class="card text-dark bg-white mb-3 shadow">
                  <img src="pic/700.jpg" class="card-img-top" width="400px" height="400px">
                    <div class="card-body">
                        <h5 class="card-title text-center">Add new Notice</h5>
						 
    <center><a href="AddNotice.jsp" class="btn btn-primary">Click Here</a></center>
                        
                    </div>
                </div>  
    
                      <div class="card text-dark bg-white mb-3 shadow">
                         <img src="pic/N001.jpg" class="card-img-top" width="400px" height="400px">
                           <div class="card-body">
                             <h5 class="card-title text-center">View all notice</h5>
                             <center><a href="Notice_View_Servelet" class="btn btn-primary">Click Here</a></center>
                           </div>
                        </div>    
