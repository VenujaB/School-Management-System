            ...
            <div class="card-body">
              ...
              <div class="card shadow">
                ...
                <div class="card-body">
                  ...
                  <div class="card shadow">
                    <img src="pic/hr001.png" class="card-img-top" width="300px" height="300px">
                    <div class="card-body">
                        <h4 class="card-title text-center">HR Manager</h4>
                        <p class="card-text text-center">Login as a HR manager</p>
                        <a href="Hr_manager_login.jsp" class="btn btn-primary btn-lg btn-block text-center">Login</a>
                      </div>
                    </div>  
