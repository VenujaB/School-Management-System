...
<head>
    ...
    <title>Manage non-Acadamic Employee</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <input type="submit" name="logout" value="Logout" class="btn btn-warning text-center shadow ml-2"></form>
...
<div class="row">
    ...
    <h1 class="text-center">Add new non-Acadamic Employee </h1>
    </div>
</div>
<br>
    ...
    <div class="col-lg-0 col-0 ml-5">
        ...
        <div class="col-lg-4 col-12">
            <div class="border ml-3 mr-3 bg-light shadow">
                <form class="mt-3 ml-3 mr-3 mb-3" action="Manager_NE_Insert_servelet" method="post">
	   ...
	   <br>
		 ...
		 <div class="form-group">
                    ...
                    <div class="text-center">
                        <button type="submit" class="btn btn-success btn-lg btn-block text-center mb-5">Add Employee</button> 
                    </div>        
                </form>
            </div>
        </div>
        <div class="col-lg-7 col-12">
            <img src="pic/EA01.jpg " height="600px" width="100%" class="ml-4">
        </div>
