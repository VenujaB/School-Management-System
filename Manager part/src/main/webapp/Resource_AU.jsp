        ...
        <div class="container">
            <diV class="card-deck">
                ...
                <div class="card text-dark bg-white mb-3 shadow">
                  <img src="pic/RAU1.jpg" class="card-img-top" width="400px" height="400px">
                  
                    <div class="card-body">
                        <h5 class="card-title text-center">Add new Resource</h5>
						 
    <center><a href="manage_resource.jsp" class="btn btn-primary">Click Here</a></center>
                        
                    </div>
                </div>  
    
                      <div class="card text-dark bg-white mb-3 shadow">
                         <img src="pic/RU01.jpg" class="card-img-top" width="350px" height="400px">
                         
                           <div class="card-body">
                             <h5 class="card-title text-center">Update Resource</h5>
                             <center><a href="ManagerResourceSearch1.jsp" class="btn btn-primary">Click Here</a></center>
                           </div>
                        </div>    
