...
<br>
        <div class="row">
            ...
            <div class="col-lg-8">
            <h1 class="text-center">HR Manager Login</h1>
            </div>
        </div>
<br>
...
<div class="col-lg-2 col-0">
    ...
    <div class="col-lg-4 col-12">
        <div class="border ml-3 mr-3 bg-light shadow">
            <form left="50px" class="mt-3 ml-3 mr-3 mb-3" action="ManagerLogin_Servelet" method="post">
    ...
    <div class="col-lg-4 col-12">
        <img src="pic/hr002.jpg" height="480px" width="150%">
    </div>
    <div class="col-lg-2 col-0">
    </div>   
</div>
