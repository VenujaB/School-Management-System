    ...
    <div class="col-lg-0 col-0 ml-5">
        ...
        <div class="col-lg-4 col-12">
            <div class="border ml-3 mr-3 bg-light shadow" >
                <form class="mt-3 ml-3 mr-3 mb-3" action="Manager_InsertResource_servlet" method="post">
					...
					<div class="form-group">
                        <label >Resource Number or Vehicle Number</label>
                    ...
                    <div class="text-center">
                        <button type="submit" name="submit" class="btn btn-success btn-lg btn-block text-center mb-5">Add Resource</button> 
                    </div>        
                </form>
            </div>
        </div>
        <div class="col-lg-7 col-12">
            <img src="pic/500.jpg " height="600px" width="100%" class="ml-4">
        </div>
