...
%-->
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
          ...
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item h6 ml-4">
              ...
              <li class="nav-item h6 ml-4">
               ...
               <li  class="nav-item h6 ml-4">
              <a class="nav-link" href="ManagerDisplayServlet">View Profile</a>
            </li>
           <!--     
              <form action="ManagerDisplayServlet" method="post">
        <input type="submit" name="Profile" value="View Profile" class="btn btn-warning text-center shadow ml-2">
        ...
        <form action="Manager_LogOut_servelet" method="post">
        <input type="submit" name="logout" value="Logout" class="btn btn-primary text-center shadow ml-2"></form>
...
<br>
          <div class="row">
               <div class="col-12 col-lg-6">
                    ...
                    <div class="col-12">
                      <div class="col-12">
                        <div class="container text-black">
                          <a href="Resource_AU.jsp" class="text-decoration-none">
                          <diV class="card text-black bg-light shadow">
                              <div class="card-body"> 
                                   <h5 class="card-title">
                                     <table style="width: 100%;">
                                       <tr>
                                         <td><img src="pic/holl.jpg" class="rounded-circle" width="100px" height="100px"></td>
                                         <td>Manage Resource</td>
                                       </tr>
                                     </table>             
                                    </h5>
                              </div>
                  ...
                  <div class="row">
                    <div class="col-12">
                      <div class="col-12">
                        <div class="container">
                          <a href="Employee_AU.jsp" class="text-decoration-none">
                          <diV class="card text-black bg-light shadow">
                              <div class="card-body"> 
                                   <h5 class="card-title">
                                     <table style="width: 100%;">
                                       <tr>
                                         <td><img src="pic/man.jpg" class="rounded-circle" width="100px" height="100px"></td>
                  ...
                  <div class="row">
                    <div class="col-12">
                      <div class="col-12">
                        <div class="container">
                          <a href="SalaryCal.jsp" class="text-decoration-none">
                          <diV class="card text-black bg-light shadow">
                              <div class="card-body"> 
                                   <h5 class="card-title">
                                     <table style="width: 100%;">
                                       <tr>
                                         <td><img src="pic/mony.jpg" class="rounded-circle" width="100px" height="100px"></td>
                                         <td>Calculate Salary</td>
                                       </tr>
                                     </table>             
                                    </h5>
                              </div>
            ...
            <div class="col-12 col-lg-6">
              <img src="pic/manger1.jpg" width="100%" height="515px">
          </div>
          </div>
