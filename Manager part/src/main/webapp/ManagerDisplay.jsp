...
<br>
       ...
       <form class="mt-3 ml-3 mr-3 mb-3" action = "ManagerDisplayServelet" method = "post">
           
       <%
       
       	Manager manager = (Manager)request.getAttribute("managerDetails");
       
       %>
       
       <div class="form-group">
             <label>Manager ID</label>
              <input type="text" class="form-control" value ="<%=manager.getId()%>" name = "tid" readonly>
            </div>
            
			<div class="form-group">
                <label >Manager Name</label>
                <input type="text" class="form-control" value = "<%=manager.getName()%>" name = "tname" readonly>
            </div>
            
             <div class="form-group">
                        <label >Manager NIC</label>
                        <input type="text" class="form-control" value = "<%=manager.getNIC()%>" name = "temail" readonly>
                    </div> 
                    
              <div class="form-group">
                        <label >Manager Email</label>
                        <input type="text" class="form-control" value = "<%=manager.getEmail()%>" name = "tnic" readonly>
                    </div>
                    
                      <div class="form-group">
                        <label >Manager Contact Number</label>
                        <input type="text" class="form-control" value = "<%=manager.getPhone()%>" name = "tcontact" readonly>
                      
                    </div>
                    
                     <div class="form-group">
                        <label >Manager DOB</label>
                        <input type="text" class="form-control" value = "<%=manager.getDOB()%>" name = "tlocation" readonly>
                      
                    </div>
                     <div class="form-group">
                        <label >Manager Username</label>
                        <input type="text" class="form-control" value = "<%=manager.getUserName()%>" name = "tgender" readonly>
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control" value = "<%=manager.getPassword()%>" name = "tdob" readonly>
                     </div> 
       ...
       <br>
       	<div class="text-center">
                     <a href="HR_main_page.jsp">   <button type="submit" class="btn btn-success text-center shadow ml-2">Back to HR Main</button> </a>
                    </div>  
                    <br>
      </div>
         <div class="col-lg-7 col-12">
            <img src="pic/400.jpg " height="600px" width="100%" class="ml-4">
        </div>
