...
$("#Oth,#Otr,#BasicSal,#EPF,#ETF,#D,#gross").keyup(function(){

var Ota=0;
var x = Number($("#Oth").val());
var y = Number($("#Otr").val());
var Ota = x*y;
$("#Ota").val(Ota);

var gross=0;
var a = Number($("#BasicSal").val());
var b = Number($("#Ota").val());
var gross = a+b;
...
var D=0;
var n = Number($("#EPF").val());
var m = Number($("#ETF").val());

var D = n+m;
$("#D").val(D);

var NS=0;
var gs=Number($("#gross").val());
var TD=Number($("#D").val());
...
<div class="col-lg-1 col-0">
    ...
    <div class="col-lg-4 col-12">
        ...
        <div class="border  ml-3 bg-light shadow" >
            <form class="mt-3 ml-3 mr-3 mb-3">
                <div class="form-group">
                    <label>Employee NIC</label>
                    <input type="text" id="EmployeeNIC" class="form-control">
					
                </div>
                <div class="form-group">
                    <label >Basic Salary</label>
                    <input type="text" id="BasicSal" class="form-control">
					
                </div>
                <div class="form-group">
                    <label>OT Hours</label>
                    <input type="text" id="Oth" class="form-control">
					
                </div>
				        <div class="form-group">
                    <label>OT Rate</label>
                    <input type="text" id="Otr" class="form-control">
					
                </div>
                <div class="form-group">
                    <label>OT Amount</label>
                    <input type="text" id="Ota" class="form-control">
                </div>
                <div class="form-group">
              ...
              <div class="form-group">
                <label>EPF</label>
                <input type="text" id="EPF" class="form-control">
            </div>
			      <div class="form-group">
                <label>ETF</label>
                <input type="text" id="ETF" class="form-control">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" id="NS" class="form-control">
              <br>
          </div>
                <div class="text-center">
                    <button type="submit" class="btn btn-danger btn-lg btn-block text-center">Reset</button> 
                </div>
                <br>				
            </form>
        </div>
    ...
    <img src="pic/cal.png" height="975px" width="100%" class="mt-5">
    </div>
</div>
