    ...
    <div class="col-lg-0 col-0 ml-5">
        ...
        <div class="col-lg-4 col-12">
            <div class="border ml-3 mr-3 bg-light shadow">
                <form class="mt-3 ml-3 mr-3 mb-3" action="Manager_DeleteNE_Servelet" method="post">
	   ...
	   <br>
		 ...
		 <div class="form-group">
                    ...
                    <div class="text-center">
                        <input type="submit" name="deleteNE" value="Delete Account"class="btn btn-success btn-lg btn-block text-center mb-5">
         ...
         <div class="col-lg-7 col-12">
            <img src="pic/Del01.jpg " height="600px" width="100%" class="ml-4">
        </div>
