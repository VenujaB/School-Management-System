        ...
        <div class="collapse navbar-collapse " id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item h6 ml-4">
              ...
              <li class="nav-item h6 ml-4">
                <a class="nav-link " href="TeacherDashbaord.jsp">Dashboard</a>
              </li>
          </ul>
...
<div class="col-lg-2 col-0">
    ...
    <div class="col-lg-4 col-12">
        <div class="border ml-3 mr-3 bg-light shadow">
            <form class="mt-3 ml-3 mr-3 mb-3" action = "TeacherLoginServlet" method = "post">
    ...
    <div class="col-lg-4 col-12">
        <img src="images/teacher2.png " height="400px" width="100%" class="ml-5">
    </div>
    <div class="col-lg-2 col-0">
    </div>   
</div>
