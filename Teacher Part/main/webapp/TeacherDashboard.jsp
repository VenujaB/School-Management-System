...
<div class="container">
    <diV class="card-deck">   
        <div class="card shadow">
            <a href="TeacherAddTimeTable.jsp"><img src="images/timetable.png" class="card-img-top" width="250px" height="350px"></a>
            <div class="card-body">
                <h4 class="card-title text-center">Add Time Table</h4>
            </div>
        </div>  
         ...
         <div class="card shadow">
          ...
          <div class="card-body">
              ...
              <div class="card shadow">
                <a href="TeacherAddMarks.jsp"><img src="images/marks update.png" class="card-img-top" width="250px" height="350px"></a>
                <div class="card-body">
                    <h4 class="card-title text-center">Add Marks</h4>
                  </div>
                </div>
                
                
                  <div class="card shadow">
                    <a href="TeacherMarksDisplayServlet"><img src="images/marks2.png" class="card-img-top" width="250px" height="350px"></a>
                    <div class="card-body">
