...
<div class="col-lg-4 col-0">
        ...
        <div class="col-lg-4 col-12">
            <div class="border ml-3 mr-3 bg-light shadow">
                <form class="mt-3 ml-3 mr-3 mb-3" action = "TeacherUpdateServlet" method = "post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value ="<%=teacher.getTName()%>" name = "tname">
                    </div> 
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value = "<%=teacher.getTNIC()%>" name = "tnic">
                    </div>
                    <div class="form-group">
                        <label >Teacher Contact Number</label>
                        <input type="number" class="form-control"  value = "<%=teacher.getTContact()%>" name = "tcontact">
                        
                    </div>
                     <div class="form-group">
                        <label >Teacher Permanent Resident</label>
                        <input type="text" class="form-control" value = "<%=teacher.getTLocation()%>" name = "tlocation">
                     ...
                     <div class="form-group">
                        ...
                        <input type="date" class="form-control" value = "<%=teacher.getTdob()%>" name = "tdob">
                    </div>

                    <div class="form-group">
                      <label >Teacher Password</label>
                      <input type="text" class="form-control"  value = "<%=teacher.getTPassword()%>" name = "tpass">
                     </div>
                           
                    <div class="text-center">
                        <button type="submit" class="btn btn-primary btn-lg btn-block text-center mb-5" name = "update">Save</button> 
                    </div> 
