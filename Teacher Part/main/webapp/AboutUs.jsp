...
<head>
    ...
    <title>About Us</title> <!-- Page Name -->
...
<div class="row">
    ...
    <div class="col-lg-4 col-12"> <!-- About Us -->
        <div class= "container text-center text-dark">
            ...
            <h1>About Us</h1>
            <br>
        <h3>This is an educational website and a good school environment for 
            children and teachers. we hope to give our 24 hours and if there 
            are have clarification you we can contact us Thank You..!!</h3>
            <br>
        </div>    
    </div>
    <div class="col-lg-6 col-12">
        <img src="images/about2.jpg" width="100%" height="500px"> <!-- About Us Picture -->
    </div>
</div>
