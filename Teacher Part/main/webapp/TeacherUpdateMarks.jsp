    ...
    <div class="col-lg-0 col-0 ml-5">
        ...
        <div class="col-lg-4 col-12">
            <div class="border ml-3 mr-3 bg-light shadow">
                <form class="mt-3 ml-3 mr-3 mb-3" action = "TeacherMarksUpdateServlet" method = "post">
                    ...
                    <div class="text-center">
                        <button type="submit" class="btn btn-success btn-lg btn-block text-center mb-5">Save</button> 
                    </div>        
                </form>
            </div>
        </div>
