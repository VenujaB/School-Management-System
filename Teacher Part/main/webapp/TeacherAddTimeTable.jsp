...
<head>
    ...
    <title>Add Time Table Page</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse " id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item ">
              <a class="nav-link h6 ml-4" href="Homejsp">Home <span class="sr-only">(current)</span></a>
            </li>
    ...
    <div class="col-lg-0 col-0 ml-5">
        ...
        <div class="col-lg-4 col-12">
            <div class="border ml-3 mr-3 bg-light shadow">
                <form class="mt-3 ml-3 mr-3 mb-3" action = "TeacherAddTimeTableServlet" method = "post">
                    ...
                    <div class="text-center">
                        <button type="submit" class="btn btn-success btn-lg btn-block text-center mb-5">Add Time Table</button> 
                    </div>        
                </form>
            </div>
        </div>
        <div class="col-lg-7 col-12">
            <img src="images/timetable2.png " height="500px" width="100%" class="ml-4">
        </div>
