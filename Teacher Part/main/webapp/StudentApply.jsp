        ...
        <div class="collapse navbar-collapse " id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item h6 ml-4">
              ...
              <li class="nav-item h6 ml-4">
                <a class="nav-link active" href="StudentApply.jsp">Apply Now</a>
              </li>
          </ul>
...
<div class="col-lg-0 col-0">
    ...
    <div class="col-lg-4 col-12">
        <div class="border  ml-3 bg-light shadow" >
            <form class="mt-3 ml-3 mr-3 mb-3" action = "StudentInsertServlet" method = "post">
                ...
                <div class="form-group">
                    ...
                    <input type="email" class="form-control" name = "eAddress" placeholder = "Email Address" >
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name = "address" placeholder = "Permanent Resident">
                </div>
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name = "gName" placeholder = "Guardian Name">
              </div>
              
              <div class="form-group">
                <label>Guardian Contact number</label>
                <input type="number" class="form-control" name = "GNumber" placeholder = "Guardian Contact number">
            </div>
    ...
    <img src="images/apply.png" height="650px" width="100%" class="mt-5">
    </div>
</div>
