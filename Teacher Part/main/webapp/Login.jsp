...
<div class="container">
    <diV class="card-deck">
        ...
        <div class="card shadow"><img src="images/adminln2.jpg" class="card-img-top" width="250px" height="350px">
            <div class="card-body">
               <h4 class="card-title text-center">Admin</h4>
               <p class="card-text text-center">Login as a Admin</p>
               <a href="LoginStudent.jsp" class="btn btn-primary btn-lg btn-block text-center">Login</a>
            </div>
        </div>  
    
    
        <div class="card shadow"><img src="images/student.png" class="card-img-top" width="250px" height="350px">
            <div class="card-body">
                <h4 class="card-title text-center">Student</h4>
                    <p class="card-text text-center">Login as a student</p>
                    <a href="StudentLogin.jsp" class="btn btn-primary btn-lg btn-block text-center">Login</a>
            </div>
        </div>  

              <div class="card shadow">
                <img src="images/teacher.png" class="card-img-top" width="250px" height="350px">
                <div class="card-body">
                    <h4 class="card-title text-center">Teacher</h4>
                    <p class="card-text text-center">Login as a teacher</p>
                    <a href="TeacherLogin.jsp" class="btn btn-primary btn-lg btn-block text-center">Login</a>
                  </div>
                </div>    

                  <div class="card shadow">
                    <img src="images/hr manager.png" class="card-img-top" width="250px" height="350px">
                    <div class="card-body">
                        <h4 class="card-title text-center">HR Manager</h4>
                        <p class="card-text text-center">Login as a HR manager</p>
                        <a href="LoginManager.jsp" class="btn btn-primary btn-lg btn-block text-center">Login</a>
                      </div>
                    </div>  
        </div>
     </div>   
