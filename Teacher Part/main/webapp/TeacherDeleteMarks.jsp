...
<div class="row">
    ...
    <h1 class="text-center">Delete Mark </h1>
    </div>
</div>
<br>
    ...
    <div class="col-lg-0 col-0 ml-5">
        ...
        <div class="col-lg-4 col-12">
            <div class="border ml-3 mr-3 bg-light shadow">
                <form class="mt-3 ml-3 mr-3 mb-3" action = "TeacherMarksDeleteServlet" method = "post">
                    <div class="form-group">
                        <label>Student ID</label>
                        <input type="text" class="form-control" placeholder = "Student ID" name = "studentid" value ="<%=StudentID%>" >
                    </div>
                    <div class="form-group">
                        <label >Student Name</label>
                        <input type="text" class="form-control"  placeholder = "Student Name" name = "studentname" value ="<%=StudentName%>">
                    </div>
                    <div class="form-group">
                        <label >Module ID</label>
                        <input type="text" class="form-control" placeholder = "Module ID" name = "moduleid" value ="<%=ModuleID%>">
                    </div>
                    <div class="form-group">
                        <label >Module Name</label>
                        <input type="text" class="form-control" placeholder = "Module Name" name = "modulename"  value ="<%=ModuleName%>" >
                    </div>
                    <div class="form-group">
                        <label >Marks</label>
                        <input type="text" class="form-control" placeholder = "Marks" name = "mark" value ="<%=Marks%>" >
                        <br>
                    </div>
                    <div class="text-center">
                        <button type="submit" class="btn btn-danger btn-lg btn-block text-center mb-5">Delete</button> 
                    </div>        
                </form>
            </div>
        </div>
        <div class="col-lg-7 col-12">
            <img src="images/marks.jpg " height="600px" width="100%" class="ml-4">
        </div>
